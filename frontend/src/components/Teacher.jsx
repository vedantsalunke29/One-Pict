...
export default function Teacher() {
	...
	return (
		<>
			{isLoading && <Loader />}
			<div className="teacher-account-main-container">
				<div className="main-teacher-center-div">
					...
					<div className="tecaher-info-div">
						<p className="Emp-p">Emp. No. : {cookieVal}</p>
					...
					<div className="contain-btn-div-accoun">
						<div className="make-accouncement-div">
							<Link to={"/make-new-accouncement"}>New Announcement</Link>
						</div>
						<div className="make-accouncement-div">
							<Link to={"/teachers-notes-page"}>Add Notes</Link>
						</div>
					</div>
				</div>
